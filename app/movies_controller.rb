...
def can_find_the_first_item_from_the_database_using_id
  Movie.all.find {|movie| movie.id == 1}
end
...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.all.find {|movie| movie.title == "Title" && movie.release_date == 2000 && movie.director == "Me"}
end
...
def can_be_found_updated_and_saved
  ...
  title = Movie.find_by(title: "Awesome Flick")
  title.update(title: "Even Awesomer Flick")
  title.save
end
